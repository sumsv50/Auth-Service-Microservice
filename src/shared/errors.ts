...
export class InvalidTokenError extends CustomError {
  ...
  public static readonly Msg = 'Invalid token';
  public static readonly HttpStatus = HttpStatusCodes.BAD_REQUEST;

  constructor() {
    super(InvalidTokenError.Msg, InvalidTokenError.HttpStatus);
  }
}

export class AccountHasBeenBlockedError extends CustomError {
  public static readonly Msg = 'Your account is banned!';
  public static readonly HttpStatus = HttpStatusCodes.UNAUTHORIZED;

  constructor() {
    super(AccountHasBeenBlockedError.Msg, AccountHasBeenBlockedError.HttpStatus);
  }
}
